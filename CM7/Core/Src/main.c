...
static void MX_USART3_UART_Init(void) {
  ...
  huart3.Init.ClockPrescaler = UART_PRESCALER_DIV32;
...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOE,
                    MOTOR4_BREAK_Pin | MOTOR2_REVERSE_Pin | MOTOR2_BREAK_Pin |
                        MOTOR3_REVERSE_Pin | OLD_MOTOR2_REVERSE_Pin |
                        MOTOR4_REVERSE_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB,
                    LED_GREEN_Pin | MOTOR1_BREAK_Pin | KICKER_CHARGE_Pin |
                        LED_RED_Pin | MOTOR1_REVERSE_Pin | NRF_CSN_Pin |
                        DRIBBLER_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(KICKER_DISCHARGE1_GPIO_Port, KICKER_DISCHARGE1_Pin,
                    GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, MOTOR3_BREAK_Pin | OLD_MOTOR2_BREAK_Pin,
                    GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MOTOR4_BREAK_Pin MOTOR2_REVERSE_Pin MOTOR2_BREAK_Pin
     MOTOR3_REVERSE_Pin OLD_MOTOR2_REVERSE_Pin MOTOR4_REVERSE_Pin LED_YELLOW_Pin
   */
  GPIO_InitStruct.Pin = MOTOR4_BREAK_Pin | MOTOR2_REVERSE_Pin |
                        MOTOR2_BREAK_Pin | MOTOR3_REVERSE_Pin |
                        OLD_MOTOR2_REVERSE_Pin | MOTOR4_REVERSE_Pin |
                        LED_YELLOW_Pin;
  ...
  /*Configure GPIO pins : LED_GREEN_Pin MOTOR1_BREAK_Pin KICKER_DISCHARGE1_Pin
     KICKER_CHARGE_Pin LED_RED_Pin MOTOR1_REVERSE_Pin NRF_CSN_Pin DRIBBLER_Pin
   */
  GPIO_InitStruct.Pin = LED_GREEN_Pin | MOTOR1_BREAK_Pin |
                        KICKER_DISCHARGE1_Pin | KICKER_CHARGE_Pin |
                        LED_RED_Pin | MOTOR1_REVERSE_Pin | NRF_CSN_Pin |
                        DRIBBLER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
