...
#define MOTOR3_ENCODER_Pin GPIO_PIN_10
#define MOTOR3_ENCODER_GPIO_Port GPIOB
#define KICKER_CHARGE_Pin GPIO_PIN_11
#define KICKER_CHARGE_GPIO_Port GPIOB
#define KICKER_DISCHARGE_Pin GPIO_PIN_12
...
#define MOTOR4_ENCODER_Pin GPIO_PIN_12
